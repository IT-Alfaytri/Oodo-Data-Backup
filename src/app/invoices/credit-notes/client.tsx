  ...
  return (
    <>
      <div className="bg-white border-b border-gray-200 px-8 py-3">
        <StatsBar
          stats={[
            { label: "Total Credit Notes", value: totalCount.toLocaleString() },
      ...
      >
        {/* ExportDialog filters prop only supports eq(), not in(), so omitting
            move_type filter. The date range filter is still functional. */}
        <ExportDialog
          tableName="invoices"
          dateColumn="date"
